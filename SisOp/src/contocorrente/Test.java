...
public class Test {
	public static void main(String args[]) throws InterruptedException {
		...
		if (cc.getDeposito() == depositoIniziale) {
			System.out.format("Funziona!. Il deposito finale è %s%n", cc.getDeposito());
		} else {
			System.out.format("Errore! Il deposito iniziale è stato di %s, il deposito finale è %s%n", depositoIniziale, cc.getDeposito());
		}
	}
