...
public class Scrittore implements Runnable {
	...
	private final static int MIN_TEMPO_SCRITTURA = 3;
	private final static int MAX_TEMPO_SCRITTURA = 9;
	private final static int MIN_TEMPO_ALTRO = 8;
	private final static int MAX_TEMPO_ALTRO = 16;
