...
public class TourLock extends Tour{
	...
	private boolean attesaConclusa=false;
	private boolean visitaConclusa=false;
	private int prima;
	private int seconda;
	private int pausa;
	
	public TourLock(int turisti) {
		super(turisti);
	}
